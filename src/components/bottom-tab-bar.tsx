...
import { Home, Mail, ClipboardList, Bookmark, User } from "lucide-react";
...
export function BottomTabBar() {
  ...
  return (
    <nav
      className="fixed bottom-0 left-0 right-0 z-50 border-t bg-white/95 backdrop-blur-md safe-bottom"
